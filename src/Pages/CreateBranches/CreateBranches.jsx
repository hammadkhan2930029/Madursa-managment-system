...
//                         <span className="bg-emerald-500/20 text-emerald-400 px-4 py-1 rounded-full text-xs font-bold mb-3 inline-block">نئی برانچ کا اندراج</span>
//                         <h1 className="text-3xl md:text-5xl font-black mb-2">{madrassaBranding.name}</h1>
//                         <p className="text-white/60 font-medium">برانچ کی تفصیلات اور ڈیفالٹ سیکوینس درج کریں</p>
//                     </div>

//                     <div className="flex gap-2">
//                         <button className="px-8 py-4 bg-[#00d094] text-white rounded-2xl font-black text-sm flex items-center gap-3 transition-all shadow-xl active:scale-95 hover:bg-[#00b07d]" onClick={handleCreate}>
...
//                 {/* 1. Sequence Settings (New Section) */}
//                 <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] shadow-sm space-y-6 md:col-span-2">
//                     <h3 className="text-lg font-black text-slate-800 border-r-4 border-[#00d094] pr-3 text-right">برانچ سیکوینس (Prefix)</h3>
//                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                         <InputField 
...
//                     <h3 className="text-lg font-black text-slate-800 border-r-4 border-[#00d094] pr-3 text-right">رابطہ کی تفصیلات</h3>
...
//                 {/* 3. Location Info */}
//                 <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] shadow-sm space-y-6">
//                     <h3 className="text-lg font-black text-slate-800 border-r-4 border-[#00d094] pr-3 text-right">مقام کی تفصیلات</h3>
//                     <div className="grid grid-cols-2 gap-4">
...
//                                 >
//                                     <span className={`font-bold ${branchData.city === "شہر منتخب کریں" ? 'text-slate-300' : 'text-slate-700'}`}>{branchData.city}</span>
...
// // InputField Component with Icon Support
// const InputField = ({ label, placeholder, value, onChange, icon }) => (
//     <div className="space-y-2 text-right">
//         <label className="text-[11px] font-black text-slate-400 mr-2 uppercase tracking-widest flex items-center justify-end gap-1">
//              {label} {icon}
//         </label>
//         <div className="p-4 rounded-2xl border bg-white border-emerald-200 ring-4 ring-emerald-50 transition-all">
//             <input
