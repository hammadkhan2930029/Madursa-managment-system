...
//     const [editMode, setEditMode] = useState(null); // Edit check karne ke liye
...
//         setIsFormOpen(true); // Form khul jayega
//     };
...
//                     <h2 className="text-2xl font-black text-slate-800 tracking-tight">مضامین کی فہرست</h2>
//                 </div>
//                 <button
...
//             {/* --- FORM (Edit & Create dono isi mein hain) --- */}
//             {isFormOpen && (
...
//                             <label className="text-[11px] font-black text-slate-500 mr-2 block">مضمون کا نام : *</label>
//                             <input
//                                 type="text"
//                                 value={formData.name}
//                                 onChange={(e) => setFormData({ ...formData, name: e.target.value })}
//                                 className="w-full bg-white border border-slate-200 focus:border-[#00d094] focus:ring-4 focus:ring-emerald-50 outline-none h-[64px] pb-2 pt-1 px-4 rounded-2xl text-lg font-bold text-right leading-[2.5]"
//                             />
//                         </div>

//                         <div className="space-y-2 text-right">
//                             <label className="text-[11px] font-black text-slate-500 mr-2 block">تفصیل / کوڈ</label>
//                             <input
//                                 type="text"
...
//                                 <th className="px-6 py-4 text-[11px] font-black text-right uppercase">مضمون</th>
//                                 <th className="px-6 py-4 text-[11px] font-black text-right uppercase">تفصیل</th>
//                                 <th className="px-6 py-4 text-[11px] font-black text-right uppercase">ایکشن</th>
//                             </tr>
//                         </thead>
//                         <tbody>
//                             {subjects.map((sub) => (
//                                 <tr key={sub.id} className={`bg-white/60 hover:bg-white hover:scale-[1.01] transition-all duration-300 group shadow-sm hover:shadow-md group rounded-2xl  ${editMode === sub.id ? 'ring-2 ring-[#00d094]' : ''}`}>
...
//                                                 className="p-2.5 bg-emerald-50 text-[#00d094] rounded-xl hover:bg-[#00d094] hover:text-white transition-all"
//                                             >
//                                                 <Edit2 size={16} />
//                                             </button>
//                                         </div>
