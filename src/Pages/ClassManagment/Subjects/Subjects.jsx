        ...
        <div className="space-y-6 animate-in fade-in duration-700 p-2" dir="rtl">
            ...
            >
                <div className="text-right">
                    ...
                    <p className="text-sm text-[var(--color-text-muted)] font-medium text-right mt-4">کل ریکارڈ: {subjects.length}</p>
                </div>
                <button
                    ...
                    <table className="w-full text-right border-separate border-spacing-y-2 px-4">
                        ...
                        <tbody>
                            {subjects.map((sub) => (
                                <tr 
                                    key={sub.id} 
                                    className={`bg-[var(--color-bg)]/40 hover:bg-[var(--color-bg)] hover:scale-[1.01] transition-all duration-300 group shadow-sm rounded-2xl ${editMode === sub.id ? 'ring-2 ring-[#00d094]' : ''}`}
                                >
                                    ...
                                    <td className="px-6 py-4 font-bold text-[var(--color-text-muted)] text-right">
                                        {sub.detail}
                                    </td>
