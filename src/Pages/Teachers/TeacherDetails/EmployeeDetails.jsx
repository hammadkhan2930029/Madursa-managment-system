...
//     Mail, MapPin, Calendar, CreditCard, Clock ,Edit,Printer
// } from 'lucide-react';

// export const EmployeeDetails = () => {
//     // Har section ki open/close state
...
//     // Accordion Item Component (Reusable)
//     const DetailSection = ({ id, title, icon: Icon, children }) => {
//         const isOpen = openSection === id;
//         return (
//             <div className="mb-4 overflow-hidden border border-white/5 rounded-[2rem] bg-[var(--color-surface)] shadow-lg transition-all duration-300">
//                 <button
//                     onClick={() => toggleSection(id)}
//                     className="w-full flex items-center justify-between p-6 md:p-8 hover:bg-[var(--color-bg)]/5 transition-colors"
//                 >
...
//                     </div>
//                     {isOpen ? <ChevronUp className="text-[var(--color-text-main)]/40" /> : <ChevronDown className="text-[var(--color-text-main)]/40" />}
//                 </button>
...
//             <p className="text-[11px] font-bold uppercase tracking-wider text-[var(--color-text-main)]/40">{label}</p>
//             <p className={`text-[15px] font-medium text-[var(--color-text-main)]/90 ${dir === 'ltr' ? 'text-left font-sans' : 'text-right'}`} dir={dir}>
//                 {value || "---"}
//             </p>
//         </div>
//     );
...
//     //   --color-primary-hover: #00b882;
//     //   --color-border: #e6fdf5;
//     //   --color-input: #f8fafc;

//     return (
//         <div className="min-h-screen space-y-6 pb-10" dir="rtl">
//             {/* --- Top Profile Header --- */}
//             <div className="bg-[var(--color-surface)] rounded-[2.5rem] p-8 shadow-xl border border-[var(--color-border)]/5 flex flex-col md:flex-row items-center gap-6">
//                 <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[var(--color-primary)] to-[#008a63] flex items-center justify-center text-3xl  font-black text-white shadow-xl shadow-emerald-500/20">
//                     H
//                 </div>
//                 <div className="text-center md:text-right space-y-2 flex-1">
//                     <h1 className="text-3xl font-black text-[var(--text-color)]">محمد حماد خان</h1>
//                     <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-5">
//                         <span className="bg-emerald-500/10 text-[var(--color-primary)] text-[10px] font-bold px-4 py-1.5 rounded-full border border-emerald-500/20">Active</span>
//                         <span className="bg-white/5 text-white/60 text-[10px] font-bold px-4 py-1.5 rounded-full">ID: EMP-2024-082</span>
//                     </div>
//                 </div>
//                 <div className="flex gap-3">
//                     <button className="flex flex-row items-center bg-[var(--color-primary)] text-[var(--color-text-main)] px-10 py-3 rounded-2xl font-bold hover:scale-105 transition-all">ایڈٹ کریں <Edit size={'24'}/></button>
//                 </div>
//                  <div className="flex gap-3">
//                     <button className="flex flex-row items-center bg-[var(--color-primary)] text-[var(--color-text-main)] px-10 py-3 rounded-2xl font-bold hover:scale-105 transition-all">پرینٹ <Printer size={'24'}/></button>
//                 </div>
//             </div>
...
//             {/* 3. تعلیمی اسناد / تجربہ */}
//             <DetailSection id="education" title="تعلیمی اسناد و تجربہ" icon={GraduationCap}>
//                 <div className="space-y-6">
//                     <div className="bg-[var(--color-bg)]/5 p-5 rounded-2xl border border-[var(--color-border)]/5">
//                         <h4 className="text-[var(--color-primary)] font-bold mb-3">ماسٹرز (اسلامک اسٹڈیز)</h4>
//                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
//                             <InfoField label="ادارے کا نام" value="جامعہ کراچی" />
//                             <InfoField label="سالِ تکمیل" value="2020" />
//                         </div>
//                     </div>
//                     <div className="bg-[var(--color-bg)]/5 p-5 rounded-2xl border border-[var(--color-border)]/5">
//                         <h4 className="text-[var(--color-primary)] font-bold mb-3">سابقہ تجربہ</h4>
//                         <p className="text-[var(--color-text)]/70 text-sm leading-relaxed">
//                             5 سال کا تدریسی تجربہ مختلف مدارس اور تعلیمی اداروں میں۔ تجوید اور عربی ادب پر عبور۔
//                         </p>
//                     </div>
//                 </div>
//             </DetailSection>
...
//                     <InfoField label="میڈیکل" value="PKR 2,000" dir="ltr" />
//                     <div className="md:col-span-1 bg-[var(--color-primary)]/10 p-4 rounded-2xl border border-[var(--color-primary)]/20">
